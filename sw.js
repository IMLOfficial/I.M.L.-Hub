...
const BG_SCRIPT='<script src="./video-inspired-bg.js?v=34"></script>';
const WIDGET_SCRIPTS=[
  '<script src="./video-library.js?v=34" defer></script>',
  '<script src="./audio-library.js?v=34" defer></script>',
  '<script src="./language-widget.js?v=34" defer></script>',
  '<script src="./music-theme.js?v=34" defer></script>',
  '<script src="./promo-ads.js?v=34" defer></script>',
  '<script src="./promo-live-files.js?v=34" defer></script>'
];
