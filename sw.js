...
const BG_SCRIPT='<script src="./video-inspired-bg.js?v=44"></script>';
const WIDGET_SCRIPTS=[
  '<script src="./video-library.js?v=44" defer></script>',
  '<script src="./promo-ads.js?v=44" defer></script>',
  '<script src="./promo-live-files.js?v=44" defer></script>',
  '<script src="./audio-library.js?v=44" defer></script>',
  '<script src="./playlist-toggle.js?v=44" defer></script>',
  '<script src="./language-widget.js?v=44" defer></script>',
  '<script src="./music-theme.js?v=44" defer></script>',
  '<script src="./music-polish.js?v=44" defer></script>',
  '<script src="./site-features.js?v=44" defer></script>',
  '<script src="./mobile-music-app.js?v=44" defer></script>'
];
